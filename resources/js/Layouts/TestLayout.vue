                ...
                <div class="sidebar-header flex items-center justify-center py-4">
                    <div class="inline-flex">
                        <a href="#" class="inline-flex flex-row items-center">
                            ...
                            <span class="leading-10 text-gray-100 text-2xl font-bold ml-1 uppercase">Loyalty Points</span>
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="flex flex-col w-full">
                        <li class="my-px">
                            <a href="#" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-700 bg-gray-100">
                                ...
                                <span class="ml-3"><Link :href="route('dashboard')" :active="route().current('dashboard')">
                            Dashboard
                                </Link></span>
                            </a>
                        </li>
                        <li class="my-px">
                            <span class="flex font-medium text-sm text-gray-300 px-4 my-4 uppercase">Program</span>
                        </li>
                        <!-- <li class="my-px">
                            <a href="#"
                        ...
                        <li class="my-px">
                            <a href="#"
                                ...
                                <span class="ml-3"> <Link :href="route('profile.show')">
                                    Settings
                                </Link></span>
                            </a>
                        </li>
                    ...
                    <div class="header-content flex items-center flex-row">
                        ...
                        <div class="flex ml-auto">
                            <a href class="flex flex-row items-center">
                             <img class="h-10 w-10 bg-gray-200 border rounded-full"
