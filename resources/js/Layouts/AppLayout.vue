    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('prgexchange')" :active="route().current('prgexchange')">
                                    Program Exchange
                                </NavLink>
                            </div>
                        </div>
            ...
            <div class=" flex items-center justify-center">
                ...
                <div class="fixed bottom-0 w-fit p-6 position-sticky">
                    <nav class="bg-white shadow dark:bg-gray-800 rounded-2xl">
                        <div
                            ...
                            <a href="#"
                                class="text-gray-800 transition-colors duration-300 transform dark:text-gray-200  mx-1.5 sm:mx-6">
                                <NavLink :href="route('prgexchange')" :active="route().current('prgexchange')">
                                    Program Exchange
                                </NavLink>
                            </a>
