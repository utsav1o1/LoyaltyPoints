...
const navigation = [
    { name: 'Dashboard', href: 'prgexchange', icon: HomeIcon, current: true },
    { name: 'Setting', href: 'profile.show', icon: CogIcon, current: false },
    // { name: 'Logouts', href: '#', icon: FolderIcon, current: false },
    // { name: 'Calendar', href: '#', icon: CalendarIcon, current: false },
    // { name: 'Documents', href: '#', icon: DocumentDuplicateIcon, current: false },
    // { name: 'Reports', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
     { id: 1, name: 'Add New', href: 'prgexchange.create', initial: '+', current: false },
    ...
    <div>
        <TransitionRoot as="template" :show="sidebarOpen">
            <Dialog as="div" class="relative z-50 lg:hidden" @close="sidebarOpen = false">
                ...
                <div class="fixed inset-0 flex bg-indigo-600">
                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                        ...
                        <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
                            ...
                            <div class="bg-indigo-600 flex grow flex-col gap-y-5 overflow-y-auto  px-6 pb-2">
        ...
        <div class="bg-indigo-600 hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col ">
            <!-- Sidebar component, swap this element with another sidebar if you like -->
            <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
                ...
                <nav class="flex flex-1 flex-col ">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                            <div class="text-xs font-semibold leading-6 text-gray-400">Programs</div>
                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                <li v-for="team in teams" :key="team.name">
                                    <a :href="route(team.href)"
                                        :class="[team.current ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50', 'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold']">
        ...
        <div class="sticky top-0 z-40 flex items-center gap-x-6 bg-white px-4 py-4 shadow-sm sm:px-6 lg:hidden">
            ...
            <a href="#">
                <span class="sr-only">Your profile</span>
                <img class="h-8 w-8 rounded-full bg-gray-50 object-cover" :src="$page.props.auth.user.profile_photo_url"
