    ...
    <div class="p-4">
        <div class="flex overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div class="w-2/3 p-4 md:p-4">
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing
                    elit In odit</p>
                ...
                <div class="flex justify-between mt-3 item-center">
                    ...
                    <button
                        class="px-2 py-1 text-xs font-bold text-white uppercase transition-colors duration-300 transform bg-gray-800 rounded dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">Read
                        MOre</button>
                </div>
            </div>
    </div>
